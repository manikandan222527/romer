          ...
          <form enctype="multipart/form-data" class="form" id="booking-form" action="kolukkumalai-contact.php"
            ...
            <div class="column">
              ...
              <!-- <div class="check-box">
                ...
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="NOV 10">NOV 11
                </label>
              </div> -->
              <div class="check-box">
                <label>
                  <input type="radio" disabled name="traval-date" id="traval-date" value="DEC 22"> <span
                    style="text-decoration: line-through;">DEC 22</span>
                </label>
              </div>
              <div class="check-box">
                <label>
