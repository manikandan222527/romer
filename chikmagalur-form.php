...
======================================== -->
  ...
  <section class="form-home">
    ...
    <ul class="banner-nav">
      ...
      <li class="locate"><a href="chikmagalur"> Chikmagalur Trek</a></li>
      <li>Booking</li>
    </ul>
  </section>
  ...
  <section class=" form-content-holder">
    ...
    <label>
            <input type="radio" name="traval-date" id="traval-date" value="OCT 21">OCT 21
              ...
              <!-- <div class="check-box">
    <label>
            <input type="radio" name="traval-date" id="traval-date" value=" OCT 27"> OCT 27
        </label>
            </div>
            <div class="check-box">
    <label>
            <input type="radio" name="traval-date" id="traval-date" value="NOV 17">NOV 17
        </label>
            </div> -->
              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="FEB 09">FEB 09
                </label>
              </div>
