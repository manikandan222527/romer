...
<body>
  ...
  <!-- <section id="slider" class="pt-5">
    <div class="container">
       <h2 class="head">
        Trip <span class="sub-head">Ctegories</span>
      </h2> 
      <div class="cat">
        <div class="cat-cards">
          <div class="cat-inner">
            <img src="assets/img/icon/cat-icon1.svg" alt="">
            <p>Trekking</p>
          </div>
        </div>
        <div class="cat-cards">
          <div class="cat-inner">
            <img src="assets/img/icon/cat-icon2.svg" alt="">
            <p>Camping</p>
          </div>
        </div>
        <div class="cat-cards">
          <div class="cat-inner">
            <img src="assets/img/icon/cat-icon3.svg" alt="">
            <p>Group</p>
          </div>
        </div>
        <div class="cat-cards">
          <div class="cat-inner">
            <img src="assets/img/icon/cat-icon4.svg" alt="">
            <p>Backpacking</p>
          </div>
        </div>
        <div class="cat-cards">
          <div class="cat-inner">
            <img src="assets/img/icon/cat-icon5.svg" alt="">
            <p>Weekend</p>
          </div>
        </div>
      </div>
  ...
  <!-- *****  Backpacking Trips  start***** -->

  <!-- test slider start -->
  <section class="upcoming-trips  py-60" id="upcoming">
    <div class="container-fluid">
      <h2 class="head">
        Upcoming Trips
      </h2>
            ...
            <a href="wayanad">
              ...
              <div class="silder-inner silder-inner1">
                ...
                <div class="inner">
                  ...
                  <h4><span id="wayanad-price">₹7,999</span> </h4>
                </div>
              </div>
            </a>
          </div>
            ...
            <a href="pondicherry">
              ...
              <div class="silder-inner silder-inner1">
                ...
                <div class="inner">
                  ...
                  <h4><span id="pondi-price">₹6,999</span> </h4>
                </div>
              </div>
            </a>
          </div>
            ...
            <a href="kolukkumalai-trek">
              ...
              <div class="silder-inner silder-inner1">
                ...
                <div class="inner">
                  ...
                  <h4><span id="munnar-price">₹7,999</span> </h4>
                </div>
              </div>
            </a>
          </div>
            ...
            <a href="ooty">
              ...
              <div class="silder-inner silder-inner1">
                ...
                <div class="inner">
                  ...
                  <h4><span id="ooty-price">₹6,999</span> </h4>
                </div>
              </div>
            </a>
          </div>
            ...
            <a href="kedarkantha">
              ...
              <div class="silder-inner silder-inner1">
                ...
                <div class="inner">
                  ...
                  <h4><span id="kedar-price">₹8,999</span> </h4>
                </div>
              </div>
            </a>
          </div>
            ...
            <a href="chikmagalur">
              ...
              <div class="silder-inner silder-inner1">
                ...
                <div class="inner">
                  ...
                  <h4><span id="chik-price">₹7,999</span> </h4>
                </div>
              </div>
            </a>
          </div>
            ...
            <a href="kerala">
              ...
              <div class="silder-inner silder-inner1">
                ...
                <div class="inner">
                  ...
                  <h4><span id="kerala-price">₹19,499</span> </h4>
                </div>
              </div>
            </a>
          </div>
            ...
            <a href="andaman">
              ...
              <div class="silder-inner silder-inner1">
                ...
                <div class="inner">
                  ...
                  <h4><span id="andaman-price">₹24,499</span> </h4>
                </div>
              </div>
            </a>
          </div>
            ...
            <a href="#home-form">
              ...
              <div class="silder-inner silder-inner1">
                ...
                <div class="inner">
                  ...
                  <h4><span id="leh-price">₹21,999</span> </h4>
                </div>
              </div>
            </a>
          </div>
            ...
            <a href="#home-form">
              ...
              <div class="silder-inner silder-inner1">
                ...
                <div class="inner">
                  ...
                  <h4><span id="goa-price">₹8,499</span> </h4>
                </div>
              </div>
            </a>
          </div>
    ...
    <div class="container-fluid">
      <div class="swiper-container1">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <a href="kerala">
              <img src="assets/img/backpacking/Keralacentre1.jpg" alt="roamers-Gallery">
              <div class="silder-inner silder-inner1">
            ...
            <a href="meghalaya">
              ...
              <div class="silder-inner silder-inner1">
                ...
                <div class="inner">
                  <h4 style="padding-right: 20px;"><img src="assets/img/images/date.svg" alt="second location-icon">
                    Opens Soon</h4>
                  <h4>Starts at <span id="megha-price">₹19,999</span> </h4>
                </div>
              </div>
            </a>
          </div>
          <div class="swiper-slide">
            <a href="#home-form">
              ...
              <div class="silder-inner silder-inner1">
                ...
                <h2>Leh-Ladakh Backpacking </h2>
                <p><img src="assets/img/images/loc.svg" alt="location-icon"> Leh, Nubra, Pangong </p>
                <div class="inner">
                  <h4 style="padding-right: 20px;"><img src="assets/img/images/date.svg" alt="second location-icon">
                    (Sold Out)</h4>
                  <h4>Starts at <span id="leh-price">₹21,999</span> </h4>
                </div>
              </div>
            </a>
          </div>
