  ...
  <section class=" form-content-holder">
    ...
    <label>
            <input type="radio" name="traval-date" id="traval-date" value=" OCT 21"> OCT 21
              ...
              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="NOV 25">NOV 25
                </label>
              </div>
              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="DEC 23">DEC 23
                </label>
              </div>
              <div class="check-box">

                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="JAN 13">JAN 13
                </label>
              </div>
            </div>
            <div class="column">
