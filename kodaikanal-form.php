...
======================================== -->
  ...
  <section class=" form-content-holder">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <form enctype="multipart/form-data" class="form" id="booking-form" action="kodaikanal-contact.php" method="POST">
            ...
            <div class="column">
              ...
              <div class="check-box">
                ...
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="JAN 26">JAN 26
                </label>
              </div>
              <div class="check-box">

                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="FEB 23">FEB 23
                </label>
              </div>
            ...
            <input style="border:none; width: 30%; position: absolute; height: 64px;" type="file" name="Resume" id="Resume" />
          </div>
            </div>
